...
# cd BatDongSan\data
# scrapy crawl ho-chi-minh-land -o dataset_HoChiMinhLand.csv

class HoChiMinhLandChoTotSpider(Spider):
    name = "ho-chi-minh-land"
    allowed_domains = ["nha.chotot.com", "gateway.chotot.com"]
    start_urls = ["https://nha.chotot.com/tp-ho-chi-minh/mua-ban-dat", ]

    def parse(self, response):
        url = 'https://nha.chotot.com/tp-ho-chi-minh/mua-ban-dat?page={}'
