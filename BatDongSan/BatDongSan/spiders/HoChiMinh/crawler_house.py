...
# cd BatDongSan\data
# scrapy crawl ho-chi-minh-house -o dataset_HoChiMinhHouse.csv

class HoChiMinhHouseChoTotSpider(Spider):
    name = "ho-chi-minh-house"
    allowed_domains = ["nha.chotot.com", "gateway.chotot.com"]
    start_urls = ["https://nha.chotot.com/tp-ho-chi-minh/mua-ban-nha-dat", ]

    def parse(self, response):
        url = 'https://nha.chotot.com/tp-ho-chi-minh/mua-ban-nha-dat?page={}'
