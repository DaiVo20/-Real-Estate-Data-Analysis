...
# cd BatDongSan\data
# scrapy crawl dong-nai-land -o dataset_DongNaiLand.csv

class DongNaiLandChoTotSpider(Spider):
    name = "dong-nai-land"
    allowed_domains = ["nha.chotot.com", "gateway.chotot.com"]
    start_urls = ["https://nha.chotot.com/dong-nai/mua-ban-dat", ]

    def parse(self, response):
        url = 'https://nha.chotot.com/dong-nai/mua-ban-dat?page={}'
