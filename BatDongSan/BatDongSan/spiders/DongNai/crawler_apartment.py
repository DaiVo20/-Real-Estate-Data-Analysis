...
# cd BatDongSan\data
# scrapy crawl dong-nai-apartment -o dataset_DongNaiApartment.csv

class DongNaiApartmentChoTotSpider(Spider):
    name = "dong-nai-apartment"
    allowed_domains = ["nha.chotot.com", "gateway.chotot.com"]
    start_urls = ["https://nha.chotot.com/dong-nai/mua-ban-can-ho-chung-cu", ]

    def parse(self, response):
        url = 'https://nha.chotot.com/dong-nai/mua-ban-can-ho-chung-cu?page={}'
