...
# cd BatDongSan\data
# scrapy crawl dong-nai-house -o dataset_DongNaiHouse.csv

class DongNaiHouseChoTotSpider(Spider):
    name = "dong-nai-house"
    allowed_domains = ["nha.chotot.com", "gateway.chotot.com"]
    start_urls = ["https://nha.chotot.com/dong-nai/mua-ban-nha-dat", ]

    def parse(self, response):
        url = 'https://nha.chotot.com/dong-nai/mua-ban-nha-dat?page={}'
